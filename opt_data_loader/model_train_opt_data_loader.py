...
from libs import (
    ...
    CLASS_COUNT, IMG_WIDTH, IMG_HEIGHT
)
from opt_data_loader.libs_opt_data_loader import load_dataset
...
model_save_path = os.path.join("./", 'model_exp_optimized.{epoch:02d}.keras')
